<nav class="bottom-nav" aria-label="Primary">
    <a href="{{ route('dashboard') }}" class="bottom-nav-link {{ request()->routeIs('dashboard') ? 'is-active' : '' }}">
    ...
    <a href="{{ route('tasks.index') }}" class="bottom-nav-link {{ request()->routeIs('tasks.index') ? 'is-active' : '' }}">
        <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><line x1="8" y1="6" x2="21" y2="6"/><line x1="8" y1="12" x2="21" y2="12"/><line x1="8" y1="18" x2="21" y2="18"/><line x1="3" y1="6" x2="3.01" y2="6"/><line x1="3" y1="12" x2="3.01" y2="12"/><line x1="3" y1="18" x2="3.01" y2="18"/></svg>
        <span>Tasks</span>
    </a>
    <a href="{{ route('tasks.board') }}" class="bottom-nav-link {{ request()->routeIs('tasks.board') ? 'is-active' : '' }}">
    ...
    <a href="{{ route('tasks.create') }}" class="bottom-nav-link bottom-nav-add {{ request()->routeIs('tasks.create') ? 'is-active' : '' }}">
